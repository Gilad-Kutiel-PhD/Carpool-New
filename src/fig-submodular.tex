\def \sst {\draw[cyan] (-2, -.5) -- (-.5, -.5);}
\def \tst {\draw[green, loosely dash dot dot] (2, -.5) -- (.5, -.5);}

\def \os {\draw[blue, loosely dotted] (-2, 1.5) -- (-2, .4);}
\def \cupst {\draw[loosely dashed] (-.5, 1.5) -- (-.5, .4);}
\def \capst {\draw[red, loosely dashed] (.5, 1.5) -- (.5, .4);}
\def \ot {\draw[orange, loosely dash dot] (2, 1.5) -- (2, .4);}

\begin{subfigure}{.48\linewidth}
\caption{\label{sub:cup}}
\centering
